...
urlpatterns = patterns('',
                       ...
                       url(r'^writers/article/comment/(?P<pk>[0-9]+)/$',
                           views.comment, name='comment'),
                       url(r'^writers/article/tags/(?P<pk>[0-9]+)/$',
                       ...
                       url(r'^writers/list/$', views.writers_list,
                           name='writers_list'),
                       url(r'^writers/detail/(?P<name>[a-zA-Z0-9_]+)/$',
                           views.writer_detail, name='writer_detail'),
                       url(r'^writers/approve/$', views.approve_writer,
                           name='approve_writer'),

                       url(r'^writers/article/add/$', views.add_writer_to_article,
                           name='add_writer'),
